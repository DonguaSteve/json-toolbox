package com.dg.jsontools.common.crash;
    ...
    public static void init(final Application app, final String crashDir) {
        Thread.setDefaultUncaughtExceptionHandler(new UncaughtExceptionHandler(){
                ...
                private void tryUncaughtException(Thread thread, Throwable throwable) {
                   ...
                   sb.append("由于程序员的疏忽，程序出现了一个不可自我修复的错误，我们对此表达诚挚的歉意。\nDue to the negligence of the programmer, the program has an irreparable error. We sincerely apologize for this.\n");
                    sb.append("请将此错误信息发送给作者，以便进一步的优化和处理。\nPlease send this error message to the author for further optimization and processing.\n\n");
